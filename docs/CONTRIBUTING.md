...
posted to #bitvaluta-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Bitvaluta code or Bitvaluta's dependency code or Bitvaluta's potential/future dependency code or research which successfully implements Bitvaluta.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 3 approvals from contributors OR unless urgent as defined by the Bitvaluta Maintainers Team.
...
- The Bitvaluta Core Team MUST act as Administrators to manage the set of project Maintainers.
